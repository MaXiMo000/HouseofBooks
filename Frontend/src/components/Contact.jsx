...
export default function Contact() {
    ...
    return (
        ...
        <div className="mx-auto max-w-2xl text-center"> 
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-white">Contact</h2>
        ...
        <form action="/" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20" ref={form} onSubmit={sendEmail}>
            ...
            <Field className="flex gap-x-4 sm:col-span-2">
                ...
                <a href="#" className="font-semibold text-indigo-600 dark:text-white">
                    privacy&nbsp;policy
                </a>
                .
                </Label>
            ...
            <button
                ...
                className="block w-full dark:text-white rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
                Let's talk
            </button>
            </div>
